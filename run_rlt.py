...
models = {
    "RLT_standard": ReinforcementLearningTree(
        n_estimators=50, use_variable_muting=False, use_linear_combination=False ,embedded_model='et'
    ),
    "RLT_muting_moderate": ReinforcementLearningTree(
        n_estimators=50, use_variable_muting=True, muting_rate=0.5, use_linear_combination=False, k_linear=1, embedded_model='et'
    ),
    "RLT_muting_aggressive": ReinforcementLearningTree(
    ...
    "RLT_RF_embedded": ReinforcementLearningTree(
        n_estimators=50, use_variable_muting=False, use_linear_combination=False , embedded_model='rf'
    )
}
